...
def test_top_side():
    ...
    x_shapes = [[Unknown(2, 2, x_grid)], [Unknown(2, 2, x_grid)]]
    y_shapes = [[Unknown(2, 2, y_grid)], [Unknown(2, 2, y_grid)]]
...
def test_84():
    ...
    x_shapes = [[FilledRectangle(0, 0, 9, 3, 8)], [FilledRectangle(0, 0, 9, 3, 8)]]
    y_shapes = [[Unknown(0, 0, y_grid)], [Unknown(0, 0, y_grid)]]
